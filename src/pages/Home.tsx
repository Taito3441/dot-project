          ...
          <div className="text-center">
            ...
            <div className="mt-8 max-w-md mx-auto">
              <div className="bg-white/70 backdrop-blur-sm border border-gray-200 rounded-2xl p-4 shadow-sm">
                <label className="block text-sm font-medium text-gray-700 mb-2">シリアルコードで入室（ログイン不要）</label>
                <div className="flex gap-2">
                  <input
                    className="flex-1 rounded-xl border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400"
                    placeholder="room-XXXXXXXXXXXX-12345"
                    value={joinCode}
                  ...
                  />
                  <button
                    onClick={() => joinCode && navigate(`/editor/${joinCode}`)}
                ...
                <p className="text-xs text-gray-500 mt-2">友だちから共有されたシリアルコードを貼り付けて入室できます。</p>
              </div>
            </div>
