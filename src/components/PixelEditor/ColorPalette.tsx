...
export const ColorPalette: React.FC<ColorPaletteProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 min-w-[340px]">
        ...
        {palette.map((color, index) => (
          <div key={index} className="relative">
            <button
              ...
              className={`w-10 h-10 rounded-lg border-2 transition-transform transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-300 \
